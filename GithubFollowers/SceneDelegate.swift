...
// Merged in some tasks yesterday in the web client
// And tested the  new inputState type in our parcel componenets. I still need to test some components of it still,
// before starting continue working ont hat ux design page story as well
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneWillEnterForeground(_ scene: UIScene) {
        // Called as the scene transitions from the backglround to the foreground.
